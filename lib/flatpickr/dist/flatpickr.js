...
function Flatpickr(element, config) {
	...
	function positionCalendar() {
		...
		if (!self.config.inline && !self.config.positionRight) {
			self.calendarContainer.style.top = top + "px";
			self.calendarContainer.style.left = left + "px";
		}
		if (self.config.positionRight){
            self.calendarContainer.style.top = top + "px";
            self.calendarContainer.style.right = 10 + "px";
            self.calendarContainer.classList.add("arrowBottomRight");
        }
	}
